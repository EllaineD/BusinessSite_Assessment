...
<div class="container">
        <nav class="navbar navbar-default" role="navigation">
                    ...
                    <li><div class="logo"><img src="{{ asset('images/favcon.png') }}" alt="logo"></div> </li>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-4">
          <div class="icon">
            ...
            <i class="bi bi-search" alt="Pill Icon"></i>
            </span>
        ...
        <div class="col-4">
          <div class="icon">
            <span class="icon-circle">
            <i class="bi bi-bootstrap-fill" alt="bootstrap"></i>
            </span>
        ...
        <div class="col-4">
          <div class="icon">
            <span class="icon-circle">
            <i class="bi bi-alarm" alt="bootstrap5"></i>
            </span>
      ...
      <div class="row">
        <div class="col-4">
          <div class="icon">
            <span class="icon-circle">
            <i class="bi bi-speedometer2" alt="speed"></i>
            </span>
        ...
        <div class="col-4">
          <div class="icon">
            <span class="icon-circle">
            <i class="bi bi-collection" alt="customise"></i>
            </span>
        ...
        <div class="col-4">
          <div class="icon">
            <span class="icon-circle">
               <i class="bi bi-arrow-clockwise" alt="upgrade"></i>
            </span>
